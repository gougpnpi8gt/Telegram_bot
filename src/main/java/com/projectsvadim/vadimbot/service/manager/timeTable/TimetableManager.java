package com.projectsvadim.vadimbot.service.manager.timeTable;
...
import com.projectsvadim.vadimbot.repository.TimeTableRepo;
...
public class TimetableManager extends AbstractManager {
    ...
    private BotApiMethod<?> deleteTimetable(CallbackQuery callbackQuery,
                                            String id,
