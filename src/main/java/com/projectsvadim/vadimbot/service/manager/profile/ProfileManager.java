package com.projectsvadim.vadimbot.service.manager.profile;
...
import static com.projectsvadim.vadimbot.service.data.CallBackData.PROFILE_REFRESH_TOKEN;
...
public class ProfileManager extends AbstractManager {
    ...
    @Autowired
    public ProfileManager(AnswerMethodFactory methodFactory, KeyboardFactory keyboardFactory,
                          UserRepo userRepo) {
